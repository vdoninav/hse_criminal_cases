...
trainer = transformers.Trainer(
    model,
    args,
    train_dataset = TokenLabelDataset(params.SAVE_DIR + 'train.pkl'),
...
''' Evaluating '''
# commented as it's already done in train after every epoch
# print("Test evaluation all:")
# print(trainer.evaluate())

print("Test evaluation per category:")
test_dataset = TokenLabelDataset(params.SAVE_DIR + 'validation.pkl')
